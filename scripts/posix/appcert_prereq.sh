...
if [[ "$APP_NAME" == "Splunk_SA_Scientific_Python_windows_x86_64" ]]; then
    ...
    mv "./bin/windows_x86_64/${VERSION//./_}/etc/conda/test-files/referencing/1/suite/.github" "./bin/windows_x86_64/${VERSION//./_}/etc/conda/test-files/referencing/1/suite/github" || echo ".github file does not exist";
