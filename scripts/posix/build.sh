...
echo "[INFO] Removing pip package from distribution"
rm -rf "$DIST_VERSION_BUILD_DIR"/lib/python*/site-packages/pip
rm -rf "$DIST_VERSION_BUILD_DIR"/lib/python*/site-packages/pip-*.dist-info
